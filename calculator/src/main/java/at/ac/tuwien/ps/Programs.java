...
public class Programs {
    ...
    public static final String RUN_PROGRAM = "((Welcome!\n)1w((Please write your program or enter the name of a predefined one (conditional|factorial|prime):\n)1w1ra s3+ (3c3< (1w1d1d)(3cc: 1 4c-3c3c4d4d4d 2ca)(3c4d1+da)a) () 2ca 0ra)0w0ra)";
    public static final String CONDITIONAL = "(0 (9~)(8)(3c4d1+da)a1w(\n)1w)";
    public static final String FACTORIAL = "((Enter number:\n)1w1ra(2c1 3c-1c1=3c()(3c4d1+da)a2d*)2c3d2ca2d1w(\n)1w)";
    ...
    */
    public static final String PRIME = "((Enter number:\n)1w1ra (1c1c*3c< (1c3c%0= (1+ 3ca)(1c1w1(\n)1wc3c/2c3d3d 3ca)(3c4d1+da)a)(1d1w(\n)1w1d)(3c4d1+da)a) 2c3d 2 3ca)";
